...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "4.2.2"
  WORKING_DIRECTORY "/workspace/concurrency-course/_deps/function2-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("4.2.2" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/4.2.2")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/workspace/concurrency-course/_deps/function2-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/workspace/concurrency-course/_deps/function2-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
