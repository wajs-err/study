...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{line_search_2_files/line_search_2_5_0.png}
    \end{center}
    { \hspace*{\fill} \\}
    
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{line_search_2_files/line_search_2_5_1.png}
    \end{center}
    { \hspace*{\fill} \\}
